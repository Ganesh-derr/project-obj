		...
		services: {
						...
						"groups": [{
							"tiles": [{
								...
								"properties": {
									...
									"targetURL": "#readdatafromexcel-display"
								}
							}]
						}]
					}
			...
			"ClientSideTargetResolution": {
				"adapter": {
					"config": {
						"inbounds": {
							"readdatafromexcel-display": {
								"semanticObject": "readdatafromexcel",
								"action": "display",
								...
								"resolutionResult": {
									...
									"additionalInformation": "SAPUI5.Component=readdatafromexcel",
									"url": sap.ui.require.toUrl("readdatafromexcel")
								}
							}
						}
					}
